...
const skills = [
  ...
  // Mobile Development
  { name: 'Android', level: 70, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/android/android-original.svg' },
  { name: 'Java', level: 75, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg' },
  { name: 'Kotlin', level: 65, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/kotlin/kotlin-original.svg' },
  // Machine Learning
  { name: 'scikit-learn', level: 70, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg' },
  { name: 'TensorFlow', level: 65, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tensorflow/tensorflow-original.svg' },
  ...
  { name: 'JWT', level: 70, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jwt/jwt-original.svg' },
  { name: 'REST APIs', level: 80, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/api/api-original.svg' },
  { name: 'Linux', level: 75, icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg' },
];
